...
import ng.min.gateway.utils.EncryptDecryptHelper;
...
public class EncryptDecryptFilter extends AbstractGatewayFilterFactory<EncryptDecryptFilter.Config> {
    ...
    public EncryptDecryptFilter(Set<MessageBodyDecoder> messageBodyDecoders, Set<MessageBodyEncoder> messageBodyEncoders) {
        super(Config.class);
