...
import ng.min.gateway.filters.EncryptDecryptFilter;
...
@Component
public class ConvertPostToGetGatewayFilter extends AbstractGatewayFilterFactory<EncryptDecryptFilter.Config> {

	private static final String REQUEST_BODY_OBJECT = "requestBodyObject";

	public ConvertPostToGetGatewayFilter(){
		super(EncryptDecryptFilter.Config.class);
	}

	@Override
	public GatewayFilter apply(EncryptDecryptFilter.Config config) {
